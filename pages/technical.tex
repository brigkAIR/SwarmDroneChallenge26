...
The challenge will take place at the \textbf{ILA Berlin} on \textbf{Thursday, 11 June 2026}. To improve state estimation in the GPS-denied indoor environment, a camera-based positioning system using ArUco markers can be used.
